...
public class NotificationsAdapter extends BaseAdapter implements ListAdapter {

    public final Activity activity;
    private ArrayList<NotificationsModel> arrayList;

    public NotificationsAdapter(Activity activity, ArrayList<NotificationsModel> arrayList) {
